...
const Work =async () => {
  ...
  return (
    <div className='max-w-3xl mx-auto pt-12'>
      ...
      <h1 className="font-medium text-xl pt-2 ml-6 sm:ml-0">Top notch projects </h1>
      <div className='grid grid-cols-1 md:grid-cols-3  gap-6 md:gap-4 lg:gap-3  py-5 mx-6 lg:mx-0'>
        {topNotchs?.map((project)=>{
          return <Card project={project} key={project._id}/>
        })}
      </div>

      <h1 className="font-medium text-xl ml-6 sm:ml-0">Other projects </h1>
      <div className='grid grid-cols-1 md:grid-cols-3  gap-6 md:gap-4 lg:gap-3  pt-5 pb-10 mx-6 lg:mx-0'>
