...
const ProjectWritting = ({writtingCover,buildCover}:Props) => {
  ...
  return (
    <div className='max-w-3xl mx-auto'>
       <h1 className='text-center font-medium text-2xl mb-4 pt-5'>~Work & Articles </h1>
          ...
          <div className='flex flex-col justify-center'>
              ...
              <div className='w-full sm:w-4/5'>
                ...
                <Image src={urlFor(buildCover?.buildCoverImage).url()} height={80} width={300} alt={'projects'} className='h-80 w-50 object-cover rounded-md'/>  
                  <button className='my-3 bg-[#1a1a1a] text-gray-50 py-2 px-3 sm:w-full w-[300px]  rounded-md font-normal text-lg capitalize'>Explore my work</button>
                </Link>     
              </div>
          </div>
          <div className='flex flex-col '>
            ...
            <div className='w-full sm:w-4/5'>
                ...
                <Image src={urlFor(writtingCover?.writtingCoverImage).url()} alt={'projects'} height={80} width={300}  className='h-80 w-50 object-cover rounded-md cursor-pointer'/>       
                  <button  className='my-3 bg-[#1a1a1a] text-gray-50 py-2 px-3 sm:w-full w-[300px] rounded-md font-normal text-lg capitalize'>Explore my Articles</button>
                </Link>
              </div>
          </div>
       </div>
